  ...
  "properties": {
    ...
    "nodes": {
      ...
      "items": {
        "type": "object",
        "properties": {
          "id": { "type": "string", "description": "Unique node identifier (e.g. node_01)" },
          "type": { "type": "string", "enum": ["action", "conditional", "loop"] },
          "action": { "type": "string", "description": "Exact registered tool name to invoke" },
          "instructions": { "type": "string", "description": "Supports double-braced reference resolution: {{nodes.node_01.output.key}}" },
    ...
    "edges": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "targetId": { "type": "string", "description": "Dependent child node ID" }
        },
