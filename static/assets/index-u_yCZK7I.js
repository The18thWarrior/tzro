...
` +
    ...
    var ht = Math.random().toString(36).slice(2),
      ...
      St = `__reactMarker$` + ht;
    function Ct(e) {
      (delete e[gt], delete e[k], delete e[vt], delete e[yt], delete e[bt]);
    }
    function wt(e) {
      var t = e[gt];
      if (t) return t;
...
`,
  ...
  oe = w(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
  se = w(`circle-check`, [
...
function De() {
  let [e, t] = (0, _.useState)(``),
    ...
    [c, l] = (0, _.useState)([
      {
        sender: `System`,
        text: `Ready. Ask me to sync databases or trigger workflows!`,
        type: `system`,
    ...
    [f, p] = (0, _.useState)(`No active task`),
    [m, h] = (0, _.useState)(!1),
    g = (0, _.useRef)(null),
    v = (0, _.useRef)(null),
    y = (0, _.useRef)({}),
    ...
    [re, w] = (0, _.useState)({}),
    [Ee, De] = (0, _.useState)([]),
    [Oe, ke] = (0, _.useState)(`con_alice`),
    [Ae, je] = (0, _.useState)([]),
    [Me, Ne] = (0, _.useState)([]),
    [Pe, Fe] = (0, _.useState)(``),
    [Ie, Le] = (0, _.useState)(``),
    [Re, ze] = (0, _.useState)(`contact`),
    [Be, Ve] = (0, _.useState)(!1),
    [He, Ue] = (0, _.useState)(``),
    [We, Ge] = (0, _.useState)(``),
    [Ke, qe] = (0, _.useState)(`#6366f1`),
    [Je, Ye] = (0, _.useState)({
    ...
    [Qe, $e] = (0, _.useState)([]),
    [et, tt] = (0, _.useState)(``),
    [nt, rt] = (0, _.useState)(!1),
    [it, at] = (0, _.useState)(``),
    [ot, st] = (0, _.useState)(!1),
    [ct, lt] = (0, _.useState)(null),
    [ut, dt] = (0, _.useState)([]),
    [ft, pt] = (0, _.useState)({}),
    mt = (0, _.useRef)(null),
    ht = (0, _.useRef)(null),
    gt = (0, _.useRef)(null),
    [k, _t] = (0, _.useState)(`tactics`),
    [vt, yt] = (0, _.useState)([]),
    [bt, xt] = (0, _.useState)(``),
    [St, Ct] = (0, _.useState)(``),
    [wt, Tt] = (0, _.useState)(`none`),
    [Et, Dt] = (0, _.useState)(``),
    [A, Ot] = (0, _.useState)(``),
    [kt, At] = (0, _.useState)(``),
    [jt, Mt] = (0, _.useState)(``),
    [Nt, Pt] = (0, _.useState)(``),
    [Ft, It] = (0, _.useState)([]),
    [Lt, Rt] = (0, _.useState)(null),
    [zt, Bt] = (0, _.useState)([]),
    [Vt, Ht] = (0, _.useState)(null),
    Ut = (0, _.useRef)(null),
    [Wt, Gt] = (0, _.useState)([]),
    [Kt, qt] = (0, _.useState)(null),
    [Jt, Yt] = (0, _.useState)([]),
    [Xt, Zt] = (0, _.useState)(!1),
    [Qt, $t] = (0, _.useState)(null),
    [en, tn] = (0, _.useState)(``),
    [nn, rn] = (0, _.useState)(``),
    [an, on] = (0, _.useState)(`manual`),
    [sn, cn] = (0, _.useState)(``),
    [ln, un] = (0, _.useState)([]),
    [dn, fn] = (0, _.useState)(``),
    [pn, mn] = (0, _.useState)(``),
  ...
  ((0, _.useEffect)(() => {
    (Pn(), Fn(), In(), Ln(), An(), zn(), bn(), xn());
    let e = setInterval(Vn, 1500),
      t = new EventSource(`/api/events`);
    return (
      (t.onmessage = (e) => {
        try {
          ...
          switch (t.source) {
            case `chat`:
              ...
              break;
            case `executor`:
              if (t.type === `node_state`) {
                if (t.taskId !== g.current) break;
                ...
                (pt((n) => {
                  ...
                  return (
                    v.current &&
                      v.current.nodes.forEach((r) => {
                        let a = (
                          r.id === t.nodeId
                            ? e
                            : n[r.id] || { status: `pending` }
                        ).status;
                        (a === `running` || a === `pending`) && (i = !0);
                      }),
                    p(
                      i
                        ? `Running: ${t.taskId.slice(-8)}`
                        : `Completed: ${t.taskId.slice(-8)}`,
                    ),
                    i || (h(!0), Pn()),
                    r
                  );
                }),
                  (e.status === `completed` || e.status === `failed`) && zn());
              } else if (t.type === `token`) {
                if (t.taskId !== g.current) break;
                pt((e) => {
                  let n = e[t.nodeId] || { status: `running`, output: `` };
                  return {
                    ...e,
                    [t.nodeId]: { ...n, output: n.output + t.content },
                  };
                });
              }
              break;
            case `workflow_orchestrator`:
              if (t.type === `workflow_state`)
                try {
                  let e = JSON.parse(t.content);
                  (Bt((t) =>
                    t.some((t) => t.id === e.executionId)
                      ? t.map((t) =>
                          t.id === e.executionId
                            ? { ...t, status: e.status }
                            : t,
                    ...
                    Ut.current &&
                      Ut.current.id === e.executionId &&
                      Gt((t) =>
                        t.some((t) => t.taskTemplateId === e.taskTemplateId)
                          ? t.map((t) =>
                              t.taskTemplateId === e.taskTemplateId
                                ? {
                                    ...t,
                                    status: e.taskStatus,
                          ...
                          : [
                              ...t,
                              {
                                workflowExecutionId: e.executionId,
                  ...
                  let n = `[${new Date().toLocaleTimeString([], { hour: `2-digit`, minute: `2-digit`, second: `2-digit` })}] Task ${e.taskTemplateId} -> ${e.taskStatus.toUpperCase()} (Execution: ${e.executionId.slice(-8)})`;
                  (Yt((e) => [n, ...e]), bn());
                } catch (e) {
                  console.error(`Failed to parse workflow state update:`, e);
                }
              break;
            case `system`:
              t.type === `promotion` &&
            ...
            case `observer`:
              ...
              break;
            case `notification`:
              if (t.type === `notification_created`)
                try {
                  let e = JSON.parse(t.content);
                  r((t) =>
                    t.some((t) => t.id === e.id)
                      ? t.map((t) => (t.id === e.id ? e : t))
                      : [e, ...t],
                  );
                } catch (e) {
          ...
          console.error(`Failed parsing SSE message chunk:`, e);
        }
      }),
      (t.onerror = (e) => {
    ...
    (0, _.useEffect)(() => {
      gt.current?.scrollIntoView({ behavior: `smooth` });
    }, [c]));
  let bn = async () => {
      try {
        let e = await fetch(`/api/workflows`);
        e.ok && It((await e.json()) || []);
      } catch (e) {
    ...
    xn = async (e) => {
      try {
        let t = e
            ? `/api/workflows/executions?workflowId=${e}`
            : `/api/workflows/executions`,
          n = await fetch(t);
        n.ok && Bt((await n.json()) || []);
      } catch (e) {
    ...
    Sn = async (e) => {
      try {
        let t = await fetch(
          `/api/workflows/executions/detail?executionId=${e}`,
        );
        t.ok && Gt((await t.json()).tasks || []);
      } catch (e) {
    ...
    Cn = async (e) => {
      try {
        if (
          ...
          Yt((n) => [`[${t}] Sent trigger command for workflow ${e}`, ...n]);
          ...
          (l((t) => [
            ...
            {
              sender: `Operator`,
              text: `Manual trigger: Executing workflow ${e}`,
              type: `user`,
              time: n,
            },
            {
    ...
    wn = async (e, t) => {
      let n = t === `active` ? `paused` : `active`;
      try {
        (
          await fetch(`/api/workflows/toggle`, {
            method: `POST`,
            headers: { "Content-Type": `application/json` },
            body: JSON.stringify({ id: e, status: n }),
          })
        ).ok && bn();
      } catch (e) {
    ...
    Tn = async (e) => {
      if (
        confirm(
          `Are you sure you want to delete this workflow definition? This will erase all execution histories and cannot be undone.`,
        )
      )
        try {
          (await fetch(`/api/workflows?id=${e}`, { method: `DELETE` })).ok &&
            (Lt?.id === e && (Rt(null), yn(null), Gt([])), bn(), xn());
        } catch (e) {
          console.error(`Failed to delete workflow:`, e);
        }
    },
    En = async (e) => {
      if ((e.preventDefault(), !en.trim())) return;
      let t = {
        id: Qt || void 0,
        name: en,
        description: nn,
        triggerType: an,
        triggerConfig: an === `cron` ? sn : ``,
        tasks: ln,
      };
      try {
        (
    ...
    Dn = (e) => {
      let t = {},
        n = (r) => {
          ...
          let i = e.find((e) => e.taskTemplateId === r);
          if (!i || !i.dependencies) return ((t[r] = 0), 0);
          let a = i.dependencies
            .split(`,`)
            .map((e) => e.trim())
            .filter(Boolean);
          if (a.length === 0) return ((t[r] = 0), 0);
          let o = 0;
          return (
            a.forEach((e) => {
              o = Math.max(o, n(e));
      ...
      e.forEach((e) => n(e.taskTemplateId));
      let r = {};
      return (
        e.forEach((e) => {
          let n = t[e.taskTemplateId] || 0;
          (r[n] || (r[n] = []), r[n].push(e));
        }),
        r
      );
    ...
    On = () => {
      if (!dn.trim() || !pn.trim() || !hn.trim()) {
        alert(`Please fill in Task Template ID, Task Name, and Instructions.`);
        return;
      }
      if (ln.some((e) => e.taskTemplateId === dn.trim())) {
        alert(`A task with this Template ID already exists in this workflow.`);
        return;
      }
      let e = {
        taskTemplateId: dn.trim(),
        name: pn.trim(),
        instructions: hn.trim(),
        dependencies: _n.join(`,`),
      };
      (un((t) => [...t, e]), fn(``), mn(``), gn(``), vn([]));
    },
    kn = (e) => {
      (un((t) => t.filter((t) => t.taskTemplateId !== e)),
        un((t) =>
          t.map((t) => {
            let n = t.dependencies
              ...
              .filter(Boolean);
            return n.includes(e)
              ? { ...t, dependencies: n.filter((t) => t !== e).join(`,`) }
              : t;
          }),
        ));
    },
      ...
      try {
        (
          await fetch(`/api/notifications/update`, {
            method: `POST`,
            headers: { "Content-Type": `application/json` },
            body: JSON.stringify({ id: e, status: t }),
          })
        ).ok && r((n) => n.map((n) => (n.id === e ? { ...n, status: t } : n)));
      } catch (e) {
        console.error(`Failed to update notification status:`, e);
      }
    },
    Mn = async () => {
      let e = n.filter((e) => e.status === `unread`);
      for (let t of e) await jn(t.id, `read`);
    },
    Nn = (e) => {
      if ((e.status === `unread` && jn(e.id, `read`), e.taskId))
        (b(e.taskId), _t(`tactics`), zn());
      else if (e.workflowId) _t(`workflows`);
      else if (e.targetId) {
        let t = e.targetId;
        (t.startsWith(`con_`) ||
          t.startsWith(`acc_`) ||
    ...
    Pn = async () => {
      try {
        let e = await fetch(`/api/memories`);
        e.ok && C((await e.json()).facts || []);
        let t = await fetch(`/api/skills`);
        t.ok && ne((await t.json()) || []);
        let n = await fetch(`/api/mcp`);
        n.ok && w((await n.json()) || {});
        let r = await fetch(`/api/entity-types`);
        r.ok && De((await r.json()) || []);
      } catch (e) {
    ...
    Fn = async () => {
      try {
        ...
        if (e.ok) {
          let t = await e.json();
          if ((Ye(t), t.ggufModelPath)) {
            let e = t.ggufModelPath.split(`/`).pop() || ``;
            tt((t) => t || `__from_config__:` + e);
          }
        }
      } catch (e) {
        console.error(`Failed to query configuration:`, e);
      }
    },
    In = async () => {
      try {
        let e = await fetch(`/api/models`);
        if (e.ok) {
          let t = await e.json();
          ($e(t || []),
            t &&
              t.length > 0 &&
              tt((e) => {
                if (e.startsWith(`__from_config__:`)) {
                  let n = e.replace(`__from_config__:`, ``),
                    r = t.find((e) => e.filename === n);
                  if (r) return r.id;
                }
                if (e && t.find((t) => t.id === e)) return e;
                let n = t.find((e) => e.downloaded);
                return n ? n.id : t.find((e) => e.isDefault)?.id || t[0].id;
              }));
        }
      } catch (e) {
    ...
    Ln = async () => {
      try {
        let e = await fetch(`/api/mcp/openapi`);
        e.ok && yt((await e.json()) || []);
      } catch (e) {
        console.error(`Failed to fetch OpenAPI integrations`, e);
      }
    },
    Rn = async (e, t) => {
      rt(!0);
      try {
        let n = {};
        t ? (n.customUrl = t) : (n.modelId = e || et);
        let r = await fetch(`/api/models/download`, {
          method: `POST`,
          headers: { "Content-Type": `application/json` },
        ...
        let a = setInterval(async () => {
          try {
            let t = await fetch(`/api/sidecar`);
            t.ok && Ze(await t.json());
            let n = await fetch(`/api/models`);
            if (n.ok) {
              let t = await n.json();
              $e(t || []);
              let r = e || et;
              if (t?.find((e) => e.id === r)?.downloaded) {
                (clearInterval(a), rt(!1), await Fn());
        ...
        setTimeout(() => {
          (clearInterval(a), rt(!1));
        }, 1800 * 1e3);
      } catch (e) {
        (console.error(`Model download failed:`, e), rt(!1));
        let t = new Date().toLocaleTimeString([], {
          hour: `2-digit`,
          minute: `2-digit`,
        });
    ...
    zn = async () => {
      try {
        let e = await fetch(`/api/tasks`);
        if (!e.ok) return;
        let t = await e.json();
        if (!t || t.length === 0) return;
        let n = t.find((e) => e.taskId === g.current);
        if ((!n && t.length > 0 && ((n = t[t.length - 1]), b(n.taskId)), n)) {
          let e = n.graph;
          (x(e), ee(n.states));
          let t = [];
          (e.nodes.forEach((e) => {
            ...
            t[n].includes(e.id) || t[n].push(e.id);
          }),
            dt(t));
          let r = !1;
          for (let e in n.states) {
            let t = n.states[e].status;
            if (t === `running` || t === `pending`) {
              r = !0;
              break;
            }
          }
          (p(
            r
              ? `Running: ${n.taskId.slice(-8)}`
              : `Completed: ${n.taskId.slice(-8)}`,
          ),
            !r && !m && (h(!0), Pn()));
        }
      } catch (e) {
        console.error(`Failed polling task runner state:`, e);
      }
    },
    Bn = (e) => {
      let t = e.toLowerCase();
      return t.includes(`fetch`) || t.includes(`analyze`) || t.includes(`cron`)
        ? 0
        : t.includes(`dedup`) || t.includes(`execute`)
          ? 1
          : 2;
    },
    Vn = async () => {
      try {
        let e = await fetch(`/api/sidecar`);
        e.ok && Ze(await e.json());
      } catch (e) {
        console.error(`Failed polling sidecar status:`, e);
      }
    },
    Hn = async (e) => {
      try {
        let t = await fetch(`/api/memories?neighborhood=${e}`);
        if (!t.ok) return;
        let n = await t.json();
        if (!n || !n.nodes) return;
        let r = mt.current,
          i = r ? r.clientWidth : 280;
        (je(
          n.nodes.map((t, r) => {
            let a = Ae.find((e) => e.id === t.id);
            if (a) return a;
            if (t.id === e) return { ...t, x: i / 2, y: 240 / 2 };
            let o = (r * 2 * Math.PI) / (n.nodes.length - 1 || 1);
            return {
              ...t,
              x: i / 2 + Math.cos(o) * 75,
              y: 240 / 2 + Math.sin(o) * 75,
            };
          }),
        ),
          Ne(n.edges || []));
      } catch (e) {
        console.error(`Failed fetching neighborhood network data:`, e);
      }
    },
    Un = (e) => {
      let t = mt.current;
      ...
      let n = t.getBoundingClientRect(),
        ...
        a = Ae.find((e) =>
          e.x === void 0 || e.y === void 0
            ? !1
            : Math.hypot(e.x - r, e.y - i) <= 24,
        );
      a && (ht.current = a);
    },
    Wn = (e) => {
      let t = mt.current;
      if (!t || !ht.current) return;
      let n = t.getBoundingClientRect(),
        r = e.clientX - n.left,
        i = e.clientY - n.top;
      ((ht.current.x = r), (ht.current.y = i), je([...Ae]));
    },
    Gn = () => {
      ht.current = null;
    },
    ...
    qn = () => {
      ...
      ((e.width = n * i),
        ...
        (t.lineWidth = 1.5),
        Me.forEach((e) => {
          let n = Ae.find((t) => t.id === e.sourceId),
            r = Ae.find((t) => t.id === e.targetId);
          n &&
            r &&
            n.x !== void 0 &&
            n.y !== void 0 &&
            ...
            t.lineTo(r.x, r.y),
            t.stroke(),
            (t.strokeStyle = `rgba(20, 220, 180, 0.25)`),
            (t.lineWidth = 1),
            t.beginPath(),
            t.moveTo(n.x, n.y),
            t.lineTo(r.x, r.y),
        ...
        Ae.forEach((e) => {
          ...
          let n = e.id === Oe,
            r =
              Ee.find((t) => t.id === e.nodeType)?.color ||
              `hsl(220, 70%, 55%)`;
          (n && ((t.shadowBlur = 15), (t.shadowColor = r)),
            (t.fillStyle = r),
            t.beginPath(),
            t.arc(e.x, e.y, n ? 12 : 9, 0, 2 * Math.PI),
            t.fill(),
            (t.shadowBlur = 0),
            (t.strokeStyle = `rgba(255, 255, 255, 0.4)`),
            (t.lineWidth = 1.5),
            t.beginPath(),
            t.arc(e.x, e.y, n ? 14 : 11, 0, 2 * Math.PI),
            t.stroke(),
            (t.fillStyle = `#f5f2fc`),
            (t.font = n ? `bold 10px Inter` : `9px Inter`),
            (t.textAlign = `center`),
            t.fillText(e.name, e.x, e.y - 18),
            (t.fillStyle = `rgba(255, 255, 255, 0.45)`),
            (t.font = `7px Fira Code, monospace`),
            t.fillText(e.id, e.x, e.y + 22));
        }));
    },
    Jn = async (n) => {
      n.preventDefault();
      ...
      (l((e) => [...e, { sender: `Operator`, text: r, type: `user`, time: i }]),
        t(``),
        f.includes(`Running:`) && (st(!0), setTimeout(() => st(!1), 6e3)));
      try {
        ...
        if (!e.ok) throw Error(`HTTP Error: ${e.statusText}`);
        let t = await e.json(),
          n = new Date().toLocaleTimeString([], {
            hour: `2-digit`,
            minute: `2-digit`,
        ...
        if (
          (t.streamId
            ? l((e) => [
                ...
                {
                  sender: `tzro Engine`,
                  text: `[${t.intent.type.toUpperCase()} / ${t.complexity}] -> `,
                  type: `agent`,
                  time: n,
                  streamId: t.streamId,
                  isStreaming: !0,
            ...
            : l((e) => [
                ...
                {
                  sender: `tzro Engine`,
                  text: `[${t.intent.type.toUpperCase()} / ${t.complexity}] -> ${t.message}`,
                  type: `agent`,
                  time: n,
                },
              ]),
          t.taskId &&
            (b(t.taskId), h(!1), p(`Running: ${t.taskId.slice(-8)}`), t.graph))
        ) {
          x(t.graph);
          let e = {};
          (t.graph.nodes.forEach((t) => {
            e[t.id] = { status: `pending`, output: `` };
          }),
            ee(e));
          let n = [];
          (t.graph.nodes.forEach((e) => {
            let t = Bn(e.id);
            for (; n.length <= t; ) n.push([]);
            n[t].includes(e.id) || n[t].push(e.id);
          }),
            dt(n));
        }
      } catch (e) {
        ...
        l((n) => [
          ...
          {
            sender: `System Error`,
            text: `Failed to route query: ${e.message}`,
            type: `system`,
            time: t,
          },
        ]);
    ...
    Yn = async (e) => {
      ...
      if (!(!t || !n))
        try {
          if (
            (
              await fetch(`/api/memories/node`, {
                method: `POST`,
                headers: { "Content-Type": `application/json` },
                body: JSON.stringify({ id: t, nodeType: Re, name: n }),
              })
            ).ok
          ) {
            ...
            l((t) => [
              ...
              {
                sender: `Graph Link`,
                text: `Added relational entity node ${n} linked directly to ${Oe}`,
                type: `system`,
                time: e,
              },
            ]);
          ...
          console.error(`Failed to add KG node entity:`, e);
        }
    },
    Xn = async (e) => {
      e.preventDefault();
        ...
        if (
          (
            await fetch(`/api/config`, {
              ...
              body: JSON.stringify({
                ...Je,
                sidecarEnabled: Je.modelMode !== `cloud`,
              }),
            })
          ).ok
        ) {
          ...
          l((t) => [
            ...t,
            {
              ...
              text: `Global configuration parameters synced and persisted successfully.`,
              type: `system`,
              time: e,
            },
          ]);
    ...
    Zn = async (e) => {
      if ((e.preventDefault(), Mt(``), Pt(``), !bt || !St || !kt || !wt)) {
        Mt(`ID, Name, Auth Type, and OpenAPI Spec are required fields.`);
        return;
      }
      try {
        JSON.parse(kt);
      } catch (e) {
        Mt(`Invalid OpenAPI Spec JSON: ${e.message}`);
        return;
      }
      try {
        let e = await fetch(`/api/mcp/openapi`, {
        ...
        if (e.ok) {
          (Pt(`OpenAPI integration saved and registered successfully!`),
            xt(``),
            Ct(``),
            At(``),
            Tt(`none`),
          ...
          l((t) => [
            ...t,
            {
              ...
              text: `Dynamic OpenAPI integration '${St}' successfully loaded and registered into the Tool Registry.`,
              type: `system`,
              time: e,
            },
          ]);
        } else Mt(`Registration failed: ${await e.text()}`);
      } catch (e) {
        Mt(`Failed to save: ${e.message}`);
      }
    },
    Qn = async (e) => {
      if (
        window.confirm(
          `Are you sure you want to delete OpenAPI integration '${e}'? This will unregister all of its dynamic tools.`,
        )
      )
        try {
          let t = await fetch(`/api/mcp/openapi?id=${e}`, { method: `DELETE` });
          if (t.ok) {
            (Ln(), Pn());
            let t = new Date().toLocaleTimeString([], {
              hour: `2-digit`,
            ...
            l((n) => [
              ...
              {
                sender: `System Router`,
                text: `OpenAPI integration '${e}' deleted. Associated dynamic tools have been unregistered.`,
                type: `system`,
                time: t,
              },
            ]);
    ...
    $n = async () => {
      try {
        ...
        l((t) => [
          ...t,
          {
            sender: `Llama Sidecar`,
            text: `Local tactical sidecar process startup sequence started.`,
            type: `system`,
            time: e,
          },
        ]);
    ...
    er = async () => {
      try {
        ...
        l((t) => [
          ...
          {
            sender: `Llama Sidecar`,
            text: `Sent process SIGINT shutdown command.`,
            type: `system`,
            time: e,
          },
        ]);
    ...
    tr = async () => {
      try {
        ...
        l((t) => [
          ...t,
          {
            sender: `GC Cache Wiped`,
            text: `Cleared persistent SQLite caches and deleted slot logs.`,
            type: `system`,
            time: e,
          },
        ]);
    ...
    nr = (() => {
      switch (Xe.status) {
        ...
        case `Starting`:
          return {
            label: `Starting`,
            pillClass: `bg-amber-500/20 text-amber-400 border-amber-500/30 animate-pulse`,
          };
        case `Adopted`:
          return {
            label: `Adopted`,
            pillClass: `bg-cyan-500/20 text-cyan-400 border-cyan-500/30`,
          };
        default:
          return {
            label: `Offline`,
  ...
  return (0, O.jsxs)(`div`, {
    className: `relative min-h-screen pb-12 overflow-hidden px-4 md:px-8`,
    "data-active-task": u || ``,
    children: [
      (0, O.jsx)(`div`, { className: `bg-blob blob-purple` }),
      (0, O.jsx)(`div`, { className: `bg-blob blob-teal` }),
      (0, O.jsx)(`div`, { className: `bg-blob blob-rose` }),
      (0, O.jsx)(`div`, {
        className: `fixed top-6 right-6 z-50 glass-panel max-w-sm rounded-xl p-4 border border-rose-500/30 shadow-lg shadow-rose-950/20 transition-all duration-500 transform ${ot ? `translate-y-0 opacity-100` : `-translate-y-12 opacity-0 pointer-events-none`}`,
        children: (0, O.jsxs)(`div`, {
          className: `flex items-start gap-3`,
          children: [
            (0, O.jsx)(`div`, {
              className: `p-2 rounded-lg bg-rose-500/20 text-rose-400`,
              children: (0, O.jsx)(Ce, { className: `w-5 h-5 animate-bounce` }),
            }),
            (0, O.jsxs)(`div`, {
              children: [
                (0, O.jsx)(`h4`, {
                  className: `font-bold text-sm text-rose-300 flex items-center gap-1.5`,
                  children: `Priority KV Preemption Alert`,
                }),
                (0, O.jsx)(`p`, {
                  className: `text-xs text-rose-200/70 mt-1 leading-relaxed`,
                  children: `Active background workflow context thread preempted. Attention cache slot-0 exported to disk. Priority console prompt served...`,
                }),
              ],
            }),
          ],
      ...
      (0, O.jsxs)(`div`, {
        className: `max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 mt-6 lg:h-[calc(100vh-6rem)] lg:overflow-hidden w-full`,
        children: [
          (0, O.jsxs)(`div`, {
            className: `flex flex-col gap-6 w-full ${o ? `hidden` : `lg:col-span-8 lg:h-full lg:min-h-0 lg:overflow-y-auto pr-2 custom-scrollbar`}`,
            children: [
              (0, O.jsxs)(`header`, {
                className: `w-full rounded-2xl glass-panel p-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6 border border-white/10 shadow-xl`,
                children: [
                  (0, O.jsxs)(`div`, {
                    className: `flex items-center gap-4 shrink-0`,
                    children: [
                      (0, O.jsx)(`div`, {
                        className: `w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-600 to-teal-400 flex items-center justify-center font-bold text-2xl shadow-lg shadow-purple-950/60 border border-white/10`,
                        children: `t`,
                      }),
                      (0, O.jsxs)(`div`, {
                        children: [
                          (0, O.jsx)(`h1`, {
                            className: `text-2xl font-black tracking-tight text-white m-0 leading-none`,
                            children: `tzro`,
                          }),
                          (0, O.jsx)(`span`, {
                            className: `text-xs font-semibold text-white/40 block mt-1.5 uppercase tracking-wider`,
                            children: `Durable Agentic Engine`,
                          }),
                        ],
                      }),
                    ],
                  ...
                  (0, O.jsxs)(`div`, {
                    className: `flex flex-col sm:flex-row flex-wrap xl:flex-nowrap items-start sm:items-center gap-4 w-full xl:w-auto xl:justify-end`,
                    children: [
                      (0, O.jsxs)(`div`, {
                        className: `flex flex-wrap items-center gap-2`,
                        children: [
                          (0, O.jsxs)(`div`, {
                            className: `status-pill px-3 py-1.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 flex items-center gap-2 text-xs font-bold shadow-sm`,
                            children: [
                              (0, O.jsx)(`span`, {
                                className: `w-1.5 h-1.5 rounded-full bg-emerald-400 glow-indicator shrink-0`,
                              }),
                              `Engine: Online`,
                            ],
                          }),
                          (0, O.jsxs)(`div`, {
                            className: `status-pill px-3 py-1.5 rounded-xl border flex items-center gap-2 text-xs font-bold shadow-sm ${nr.pillClass}`,
                            children: [
                              (0, O.jsx)(`span`, {
                                className: `w-1.5 h-1.5 rounded-full bg-current shrink-0 ${Xe.status === `Starting` ? `animate-ping` : ``}`,
                              }),
                              `Llama-Server: `,
                              nr.label,
                            ],
                          ...
                          (0, O.jsxs)(`div`, {
                            className: `status-pill px-3 py-1.5 rounded-xl border border-teal-500/20 bg-teal-500/5 text-teal-400 flex items-center gap-2 text-xs font-bold shadow-sm`,
                            children: [
                              (0, O.jsx)(`span`, {
                          ...
                          (0, O.jsxs)(`div`, {
                            className: `status-pill px-3 py-1.5 rounded-xl border border-purple-500/20 bg-purple-500/5 text-purple-400 flex items-center gap-2 text-xs font-bold shadow-sm`,
                            children: [
                              (0, O.jsx)(`span`, {
                          ...
                          (0, O.jsxs)(`div`, {
                            className: `status-pill px-3 py-1.5 rounded-xl border border-cyan-500/20 bg-cyan-500/5 text-cyan-400 flex items-center gap-2 text-xs font-bold shadow-sm`,
                            children: [
                              (0, O.jsx)(`span`, {
                      ...
                      (0, O.jsxs)(`div`, {
                        className: `flex items-center gap-2 shrink-0 border-l border-white/10 pl-0 sm:pl-4 mt-2 sm:mt-0`,
                        children: [
                          (0, O.jsxs)(`button`, {
                            onClick: () => a(!0),
                            ...
                            children: [
                              (0, O.jsx)(ie, { className: `w-4 h-4` }),
                              n.filter((e) => e.status === `unread`).length >
                                0 &&
                                (0, O.jsx)(`span`, {
                                  className: `absolute -top-1 -right-1 w-5 h-5 bg-rose-500 rounded-full text-[10px] font-black flex items-center justify-center text-white animate-pulse shadow-md border border-slate-950`,
                                  children: n.filter(
                                    (e) => e.status === `unread`,
                                  ).length,
                                }),
                          ...
                          (0, O.jsx)(`button`, {
                            ...
                            className: `p-2.5 rounded-xl border transition-all cursor-pointer shadow-md flex items-center justify-center ${k === `settings` ? `bg-teal-500/10 border-teal-500/30 text-teal-400 shadow-lg shadow-teal-500/5` : `bg-white/5 hover:bg-white/10 border border-white/10 text-white/70 hover:text-white`}`,
                            title: `Settings & Configurations`,
                            children: (0, O.jsx)(ve, { className: `w-4 h-4` }),
                          }),
                        ],
                      }),
                    ],
              ...
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsxs)(`button`, {
                    onClick: () => _t(`tactics`),
                    className: `px-5 py-2.5 rounded-xl border font-bold text-xs uppercase tracking-wider transition-all cursor-pointer flex items-center gap-2 ${k === `tactics` ? `bg-teal-500/10 border-teal-500/30 text-teal-400 shadow-lg shadow-teal-500/5` : `bg-white/3 border-white/5 text-white/50 hover:text-white/80`}`,
                    children: [
                      (0, O.jsx)(de, { className: `w-4 h-4` }),
                      `Task Tactics`,
                    ],
                  }),
                  (0, O.jsxs)(`button`, {
                    onClick: () => {
                      (_t(`workflows`), bn(), xn(Lt?.id));
                    },
                    className: `px-5 py-2.5 rounded-xl border font-bold text-xs uppercase tracking-wider transition-all cursor-pointer flex items-center gap-2 ${k === `workflows` ? `bg-teal-500/10 border-teal-500/30 text-teal-400 shadow-lg shadow-teal-500/5` : `bg-white/3 border-white/5 text-white/50 hover:text-white/80`}`,
                    children: [
                      (0, O.jsx)(we, { className: `w-4 h-4` }),
                      `Workflows Control`,
                    ],
                  }),
                  (0, O.jsxs)(`button`, {
                    ...
                    className: `px-5 py-2.5 rounded-xl border font-bold text-xs uppercase tracking-wider transition-all cursor-pointer flex items-center gap-2 ${k === `settings` ? `bg-teal-500/10 border-teal-500/30 text-teal-400 shadow-lg shadow-teal-500/5` : `bg-white/3 border-white/5 text-white/50 hover:text-white/80`}`,
                    children: [
                      (0, O.jsx)(ve, { className: `w-4 h-4` }),
                      `Settings Config`,
                    ],
                  }),
                ],
              ...
              k === `tactics` &&
                (0, O.jsxs)(`div`, {
                  ...
                  children: [
                    (0, O.jsxs)(`div`, {
                      className: `glass-panel rounded-2xl p-5 flex flex-col min-h-[400px]`,
                      children: [
                        (0, O.jsxs)(`div`, {
                          className: `flex items-center justify-between border-b border-white/5 pb-3 mb-3`,
                          children: [
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, O.jsx)(`h2`, {
                                  ...
                                  children: `Kahn DAG Pipeline Tracker`,
                                }),
                              ],
                            }),
                            (0, O.jsx)(`span`, {
                              className: `px-2 py-1 rounded text-[10px] font-bold flex items-center gap-1.5 border ${f.includes(`Completed`) ? `bg-emerald-500/20 border-emerald-500/30 text-emerald-400` : f.includes(`Running`) ? `bg-amber-500/20 border-amber-500/30 text-amber-400 animate-pulse` : `bg-white/5 border-white/10 text-white/50`}`,
                              children: f,
                            }),
                          ],
                        }),
                        (0, O.jsx)(`div`, {
                          className: `flex-1 overflow-x-auto flex flex-col gap-4`,
                          children:
                            !ct || ut.length === 0
                              ? (0, O.jsxs)(`div`, {
                                  className: `flex-1 flex flex-col items-center justify-center gap-3 text-white/30 italic text-center p-8`,
                                  children: [
                                    (0, O.jsx)(de, {
                                    ...
                                    (0, O.jsx)(`p`, {
                                      ...
                                      children: `Submit a workflow in the Console to see compiled topological DAG pipeline stages run parallel nodes here.`,
                                    }),
                                  ],
                                })
                              : (0, O.jsx)(`div`, {
                                  ...
                                  children: ut.map((e, t) =>
                                    (0, O.jsxs)(
                                      `div`,
                                      {
                                        className: `flex-1 flex flex-col gap-3 p-3 rounded-xl bg-white/2 border border-white/5 min-w-[200px]`,
                                        children: [
                                          (0, O.jsxs)(`div`, {
                                            className: `text-[10px] font-bold uppercase tracking-wider text-teal-400/70 border-b border-white/5 pb-1`,
                                            children: [`Stage Level `, t + 1],
                                          }),
                                          (0, O.jsx)(`div`, {
                                            ...
                                            children: e.map((e) => {
                                              ...
                                              let n = ft[e] || {
                                                ...
                                                r = `border-white/10 bg-white/3 text-white/40`;
                                              n.status === `running`
                                                ? (r = `border-amber-500/50 bg-amber-500/10 text-amber-400`)
                                                : n.status === `completed`
                                                  ? (r = `border-emerald-500/50 bg-emerald-500/10 text-emerald-400`)
                                                  : n.status === `failed` &&
                                                    (r = `border-rose-500/50 bg-rose-500/10 text-rose-400`);
                                              let i = n.output || ``,
                                                a =
                                                  i.includes(
                                                    `[Local Tactician]`,
                                              ...
                                              return (
                                                ...
                                                (0, O.jsxs)(
                                                  `div`,
                                                  {
                                                    className: `p-3 rounded-xl border flex flex-col gap-2 transition-all ${r}`,
                                                    children: [
                                                      (0, O.jsxs)(`div`, {
                                                        className: `flex items-center justify-between gap-1.5`,
                                                        children: [
                                                          (0, O.jsx)(`span`, {
                                                            className: `font-mono text-[9px] px-1.5 py-0.5 rounded bg-white/5 font-semibold tracking-wider text-white`,
                                                            children: t.action,
                                                          }),
                                                          (0, O.jsxs)(`div`, {
                                                            ...
                                                            children: [
                                                              a &&
                                                                (0, O.jsx)(
                                                                  `span`,
                                                                  {
                                                                    className: `text-[8px] bg-emerald-500/20 text-emerald-300 px-1 py-0.5 rounded border border-emerald-500/20 font-bold uppercase`,
                                                                    children: `Local`,
                                                                  },
                                                                ),
                                                              o &&
                                                                (0, O.jsx)(
                                                                  `span`,
                                                                  {
                                                                    className: `text-[8px] bg-purple-500/20 text-purple-300 px-1 py-0.5 rounded border border-purple-500/20 font-bold uppercase`,
                                                                    children: `Cloud`,
                                                                  },
                                                                ),
                                                              s &&
                                                                (0, O.jsxs)(
                                                                  `span`,
                                                                  {
                                                                    className: `text-[8px] bg-cyan-500/20 text-cyan-300 px-1 py-0.5 rounded border border-cyan-500/20 font-bold uppercase flex items-center gap-0.5`,
                                                                    children: [
                                                                      (0,
                                                                      O.jsx)(
                                                                        le,
                                                              ...
                                                              (0, O.jsx)(
                                                                `span`,
                                                                {
                                                                  className: `w-1.5 h-1.5 rounded-full bg-current ${n.status === `running` ? `animate-pulse` : ``}`,
                                                                },
                                                              ),
                                                            ],
                                                          }),
                                                      ...
                                                      (0, O.jsx)(`div`, {
                                                        className: `text-[10px] font-bold text-white capitalize`,
                                                        children: t.id.replace(
                                                          /_/g,
                                                          ` `,
                                                        ),
                                                      }),
                                                      (0, O.jsx)(`p`, {
                                                        className: `text-[10px] text-white/60 leading-normal`,
                                                        children:
                                                          t.instructions,
                                                      }),
                                                      i &&
                                                        (0, O.jsx)(`pre`, {
                                                          className: `terminal-font text-[8px] bg-slate-950/40 p-2 border border-white/5 rounded-lg text-teal-300 overflow-x-auto max-h-[80px]`,
                                                          children: i,
                                                        }),
                                                    ],
                                                  },
                    ...
                    (0, O.jsxs)(`div`, {
                      ...
                      children: [
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                (0, O.jsxs)(`div`, {
                                  className: `flex items-center gap-2 border-b border-white/5 pb-3 mb-2`,
                                  children: [
                                    (0, O.jsx)(fe, {
                                    ...
                                    (0, O.jsx)(`h2`, {
                                      className: `text-base font-bold text-white leading-none`,
                                      children: `Relational Graph & RAG`,
                                    }),
                                  ],
                                }),
                                (0, O.jsx)(`p`, {
                                  className: `text-[11px] text-white/50 leading-relaxed mb-3 font-semibold`,
                                  children: `Traverse nodes & connections up to 2-hops. Double-click a node to center neighborhood.`,
                                }),
                                (0, O.jsxs)(`div`, {
                                ...
                                (0, O.jsx)(`div`, {
                                  className: `w-full h-[200px] border border-white/5 bg-slate-950/30 rounded-xl relative overflow-hidden mb-4`,
                                ...
                                (0, O.jsxs)(`form`, {
                                  onSubmit: Yn,
                                  className: `border-t border-white/5 pt-3.5 flex flex-col gap-3`,
                                  children: [
                                    (0, O.jsx)(`h3`, {
                                      className: `text-xs font-bold text-white uppercase tracking-wider text-teal-400/80 m-0`,
                                      children: `Grow Knowledge Graph`,
                                    }),
                                    (0, O.jsxs)(`div`, {
                                ...
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, O.jsx)(`h3`, {
                                          className: `text-[10px] font-bold text-white/50 uppercase tracking-wider m-0`,
                                    ...
                                    (0, O.jsx)(`div`, {
                                      ...
                                      children: Ee.map((e) =>
                                        (0, O.jsxs)(
                                          `div`,
                                          {
                                            className: `flex items-center gap-1 px-2 py-1 rounded-lg border border-white/10 bg-white/3 text-[10px] font-semibold text-white/80`,
                                            children: [
                                              (0, O.jsx)(`span`, {
                            ...
                            (0, O.jsxs)(`div`, {
                              className: `glass-panel rounded-2xl p-5 flex flex-col h-[280px]`,
                              children: [
                                (0, O.jsxs)(`div`, {
                                  className: `flex items-center gap-2 border-b border-white/5 pb-3 mb-3`,
                                  children: [
                                    (0, O.jsx)(ce, {
                                      className: `w-5 h-5 text-teal-400`,
                                    }),
                                ...
                                (0, O.jsx)(`div`, {
                                  ...
                                  children:
                                    Object.keys(re).length === 0
                                      ? (0, O.jsx)(`div`, {
                                          className: `h-full flex items-center justify-center text-xs text-white/30 italic`,
                                          children: `No daemon configs found`,
                                        })
                                      : Object.keys(re).map((e) =>
                                          (0, O.jsxs)(
                                            `div`,
                                            {
                                              className: `p-3 rounded-xl bg-white/3 border border-white/5 flex flex-col gap-2`,
                                              children: [
                                                (0, O.jsxs)(`div`, {
                                                  ...
                                                  children: [
                                                    ...
                                                    (0, O.jsx)(`span`, {
                                                      className: `px-2 py-0.5 rounded text-[8px] bg-teal-500/20 text-teal-300 border border-teal-500/30 font-bold uppercase`,
                                                      children: `Active Stdio`,
                                                    }),
                                                  ],
                                                }),
                                                (0, O.jsxs)(`pre`, {
                                                  className: `terminal-font text-[9px] text-white/40 leading-normal whitespace-pre-wrap break-all`,
                                                  children: [
                                                    re[e].command,
                                                    ` `,
                                                    re[e].args.join(` `),
                        ...
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsxs)(`div`, {
                              className: `glass-panel rounded-2xl p-5 flex flex-col h-[320px]`,
                              children: [
                                (0, O.jsxs)(`div`, {
                                  className: `flex items-center gap-2 border-b border-white/5 pb-3 mb-3`,
                                  children: [
                                    ...
                                    (0, O.jsx)(`h2`, {
                                      className: `text-base font-bold text-white leading-none`,
                                      children: `Facts Memory & Insights`,
                                    }),
                                  ],
                                }),
                                (0, O.jsx)(`div`, {
                                  ...
                                  children:
                                    S.length === 0
                                      ? (0, O.jsx)(`div`, {
                                          className: `h-full flex items-center justify-center text-xs text-white/30 italic`,
                                          children: `No memory elements fetched yet`,
                                        })
                                      : S.map((e) =>
                                          (0, O.jsxs)(
                                            `div`,
                                            {
                                              className: `p-3 rounded-xl bg-white/3 border border-white/5 flex flex-col gap-1.5`,
                                              children: [
                                                (0, O.jsxs)(`div`, {
                                                  className: `flex items-center justify-between gap-2`,
                                                  children: [
                                                    (0, O.jsx)(`span`, {
                                                      className: `px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider bg-purple-500/20 text-purple-300 border border-purple-500/30`,
                                                ...
                                                e.context &&
                                                  (0, O.jsx)(`span`, {
                                                    className: `text-[10px] text-white/40 block leading-tight font-mono truncate`,
                                                    children: e.context,
                                                  }),
                                              ],
                                            },
                              ...
                              children: [
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, O.jsx)(`h2`, {
                                      className: `text-base font-bold text-white leading-none`,
                                      children: `Synthesized SOP Skills`,
                                    }),
                                  ],
                                }),
                                (0, O.jsx)(`div`, {
                                  ...
                                  children:
                                    te.length === 0
                                      ? (0, O.jsx)(`div`, {
                                          className: `h-full flex items-center justify-center text-xs text-white/30 italic`,
                                          children: `No procedural skills synthesized yet`,
                                        })
                                      : te.map((e) =>
                                          (0, O.jsxs)(
                                            `div`,
                                            {
                                              ...
                                              children: [
                                                (0, O.jsxs)(`div`, {
                                                  className: `font-bold text-xs text-white flex items-center gap-1.5`,
                                                  children: [
                                                    (0, O.jsx)(se, {
                                                ...
                                                (0, O.jsx)(`p`, {
                                                  className: `text-[11px] text-white/50 leading-relaxed font-semibold`,
                                                  children:
                                                    e.triggerDescription,
                                                }),
                                                (0, O.jsx)(`pre`, {
                                                  className: `terminal-font text-[9px] bg-slate-950/40 p-2.5 rounded-lg border border-white/5 text-purple-300 max-h-[90px] overflow-y-auto`,
                                                  children: (0, O.jsx)(`code`, {
                                                    children: e.sopContent,
                                                  }),
                                                }),
                                              ],
                                            },
              ...
              k === `workflows` &&
                (0, O.jsxs)(`div`, {
                  className: `grid grid-cols-1 xl:grid-cols-12 gap-6 items-start animate-fade-in w-full`,
                  children: [
                    (0, O.jsxs)(`div`, {
                      className: `xl:col-span-4 flex flex-col gap-6 w-full`,
                      children: [
                        (0, O.jsxs)(`div`, {
                          className: `glass-panel rounded-2xl p-5 flex flex-col min-h-[300px]`,
                          children: [
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, O.jsx)(`h2`, {
                                      className: `text-sm font-bold text-white uppercase tracking-wider m-0`,
                                      children: `Workflows`,
                                    }),
                                  ],
                                }),
                            ...
                            (0, O.jsx)(`div`, {
                              className: `flex-1 overflow-y-auto space-y-3 max-h-[400px] pr-1`,
                              children:
                                Ft.length === 0
                                  ? (0, O.jsx)(`div`, {
                                      className: `h-full flex items-center justify-center text-xs text-white/30 italic py-8 text-center`,
                                      children: `No workflows created yet. Click "+" to build one!`,
                                    })
                                  : Ft.map((e) => {
                                      let t = Lt?.id === e.id,
                                        n = e.triggerType === `cron`;
                                      return (0, O.jsxs)(
                                        `div`,
                                        {
                                          onClick: () => {
                                            (Rt(e), qt(null), xn(e.id));
                                          },
                                          className: `p-3.5 rounded-xl border transition-all cursor-pointer flex flex-col gap-2 ${t ? `border-teal-500/40 bg-teal-500/5 shadow-lg shadow-teal-500/5` : `border-white/5 bg-white/2 hover:border-white/10 hover:bg-white/4`}`,
                                          children: [
                                            (0, O.jsxs)(`div`, {
                                              className: `flex items-center justify-between gap-2`,
                                              children: [
                                                ...
                                                (0, O.jsx)(`span`, {
                                                  className: `px-2 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider ${e.status === `active` ? `bg-emerald-500/20 text-emerald-400 border border-emerald-500/20` : `bg-white/5 text-white/40 border border-white/5`}`,
                                                  children: e.status,
                                                }),
                                              ],
                                            }),
                                            (0, O.jsx)(`p`, {
                                              className: `text-[10px] text-white/50 leading-relaxed font-medium m-0 line-clamp-2`,
                                              children:
                                                e.description ||
                                            ...
                                            (0, O.jsxs)(`div`, {
                                              ...
                                              children: [
                                                (0, O.jsx)(`span`, {
                                                  className: `text-[9px] text-teal-400/80 font-semibold uppercase tracking-wider`,
                                                  children: n
                                                    ? `Cron: ${e.triggerConfig}`
                                                    : `Manual`,
                                                }),
                                                (0, O.jsxs)(`div`, {
                                                  ...
                                                  children: [
                                                    ...
                                                    (0, O.jsx)(`button`, {
                                                      onClick: () =>
                                                        wn(e.id, e.status),
                                                      className: `p-1 rounded border border-white/5 transition-all ${e.status === `active` ? `bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20` : `bg-white/5 text-white/50 hover:bg-white/10`}`,
                                                      title:
                                                        e.status === `active`
                                                          ? `Pause scheduling`
                                                          : `Activate scheduling`,
                                            ...
                                            n &&
                                              ...
                                              e.nextRunAt > 0 &&
                                              (0, O.jsxs)(`div`, {
                                                className: `text-[8px] text-white/30 font-mono mt-0.5`,
                                                children: [
                                                  `Next run: `,
                                                  new Date(
                                                    e.nextRunAt * 1e3,
                        ...
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsxs)(`div`, {
                              className: `flex items-center gap-2 border-b border-white/5 pb-3 mb-4`,
                              children: [
                                (0, O.jsx)(le, {
                                  className: `w-5 h-5 text-purple-400`,
                                }),
                                (0, O.jsx)(`h2`, {
                                  className: `text-sm font-bold text-white uppercase tracking-wider m-0`,
                                  children: `Runs History`,
                                }),
                              ],
                            }),
                            (0, O.jsx)(`div`, {
                              className: `flex-1 overflow-y-auto space-y-2.5 max-h-[350px] pr-1`,
                              children:
                                zt.length === 0
                                  ? (0, O.jsx)(`div`, {
                                      className: `h-full flex items-center justify-center text-xs text-white/30 italic py-8 text-center`,
                                  ...
                                  : zt.map((e) => {
                                      let t = Vt?.id === e.id,
                                        n = `bg-white/5 border-white/5 text-white/50`;
                                      return (
                                        e.status === `running`
                                          ? (n = `bg-amber-500/20 border-amber-500/30 text-amber-400 animate-pulse`)
                                          : e.status === `completed`
                                            ? (n = `bg-emerald-500/20 border-emerald-500/30 text-emerald-400`)
                                            : e.status === `failed` &&
                                              (n = `bg-rose-500/20 border-rose-500/30 text-rose-400`),
                                        (0, O.jsxs)(
                                          `div`,
                                          {
                                            onClick: () => {
                                              (yn(e), qt(null), Sn(e.id));
                                            },
                                            className: `p-3 rounded-xl border transition-all cursor-pointer flex flex-col gap-1.5 ${t ? `border-purple-500/40 bg-purple-500/5 shadow-lg shadow-purple-500/5` : `border-white/5 bg-white/2 hover:border-white/10 hover:bg-white/4`}`,
                                            children: [
                                              (0, O.jsxs)(`div`, {
                                                className: `flex items-center justify-between gap-2`,
                                                children: [
                                                  (0, O.jsx)(`span`, {
                                                    className: `font-mono text-[10px] font-bold text-white tracking-wider`,
                                                    children: e.id.slice(-12),
                                                  }),
                                                  (0, O.jsx)(`span`, {
                                                    className: `px-2 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider border ${n}`,
                                                    children: e.status,
                                                  }),
                                                ],
                                              }),
                                              (0, O.jsxs)(`div`, {
                                                className: `flex items-center justify-between text-[9px] text-white/40`,
                                                children: [
                                                  (0, O.jsxs)(`span`, {
                                                    children: [
                                                      `Started: `,
                    ...
                    (0, O.jsxs)(`div`, {
                      className: `xl:col-span-8 flex flex-col gap-6 w-full`,
                      children: [
                        (0, O.jsxs)(`div`, {
                          className: `glass-panel rounded-2xl p-5 flex flex-col min-h-[500px]`,
                          children: [
                            (0, O.jsxs)(`div`, {
                              className: `flex items-center justify-between border-b border-white/5 pb-3 mb-4`,
                              children: [
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsx)(we, {
                                      className: `w-5 h-5 text-teal-400 animate-pulse`,
                                    }),
                                    (0, O.jsxs)(`div`, {
                                      children: [
                                        (0, O.jsx)(`h2`, {
                                        ...
                                        Vt &&
                                          (0, O.jsxs)(`span`, {
                                            className: `text-[10px] font-mono text-purple-400 font-semibold tracking-wider block mt-1`,
                                            children: [`Run ID: `, Vt.id],
                                          }),
                                      ],
                                    }),
                                  ],
                                ...
                                Vt &&
                                  (0, O.jsx)(`span`, {
                                    className: `px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-wider border ${Vt.status === `completed` ? `bg-emerald-500/20 border-emerald-500/30 text-emerald-400` : Vt.status === `running` ? `bg-amber-500/20 border-amber-500/30 text-amber-400 animate-pulse` : `bg-rose-500/20 border-rose-500/30 text-rose-400`}`,
                                    children: Vt.status,
                                  }),
                              ],
                            }),
                            (0, O.jsx)(`div`, {
                              className: `flex-1 overflow-x-auto flex flex-col justify-center items-stretch py-4`,
                              children: Lt
                                ? Vt
                                  ? (() => {
                                      let e = Dn(Lt.tasks);
                                      return (0, O.jsx)(`div`, {
                                        className: `flex flex-col md:flex-row gap-6 items-stretch justify-center h-full min-h-[380px]`,
                                        children: Object.keys(e)
                                          ...
                                          .map((t) => {
                                            ...
                                            return (0, O.jsxs)(
                                              `div`,
                                              {
                                                className: `flex-1 flex flex-col gap-4 p-4 rounded-xl bg-white/2 border border-white/5 min-w-[200px]`,
                                                children: [
                                                  (0, O.jsxs)(`div`, {
                                                    className: `text-[10px] font-bold uppercase tracking-wider text-teal-400/80 border-b border-white/5 pb-2`,
                                                    children: [
                                                      `Stage Level `,
                                                      t + 1,
                                                    ],
                                                  ...
                                                  (0, O.jsx)(`div`, {
                                                    className: `flex-1 flex flex-col gap-4 justify-start`,
                                                    children: n.map((e) => {
                                                      let t = Wt.find(
                                                          (t) =>
                                                            t.taskTemplateId ===
                                                        ...
                                                        n = t
                                                          ? t.status
                                                          : `pending`,
                                                        r = `border-white/10 bg-white/2 text-white/40`,
                                                        i = `Pending`,
                                                        a = ``;
                                                      n === `running`
                                                        ? ((r = `border-amber-500/50 bg-amber-500/10 text-amber-400`),
                                                      ...
                                                      let o =
                                                        Kt?.taskTemplateId ===
                                                        e.taskTemplateId
                                                          ? `ring-2 ring-teal-400 border-transparent shadow-lg shadow-teal-500/10`
                                                          : ``;
                                                      return (0, O.jsxs)(
                                                        `div`,
                                                        {
                                                          onClick: () => qt(e),
                                                          className: `p-3.5 rounded-xl border flex flex-col gap-2.5 transition-all cursor-pointer hover:scale-[1.02] ${r} ${o}`,
                                                          children: [
                                                            (0, O.jsxs)(`div`, {
                                                              className: `flex items-center justify-between gap-1.5`,
                                                              children: [
                                                                (0, O.jsx)(
                                                                  `span`,
                                                                  {
                                                                    className: `font-mono text-[9px] px-1.5 py-0.5 rounded bg-white/5 font-bold tracking-wider text-white`,
                                                                    children:
                                                                      e.taskTemplateId,
                                                                  },
                                                                ),
                                                                  ...
                                                                  `div`,
                                                                  {
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      O.jsx)(
                                                                        `span`,
                                                                        {
                                                                          className: `w-2 h-2 rounded-full bg-current ${a}`,
                                                                        },
                                                                      ),
                                                                    ],
                                                                  },
                                                            ...
                                                            (0, O.jsx)(`div`, {
                                                              className: `text-[11px] font-bold text-white capitalize leading-tight`,
                                                              children: e.name,
                                                            }),
                                                            (0, O.jsx)(`p`, {
                                                              className: `text-[10px] text-white/60 leading-normal m-0 line-clamp-2`,
                                                              children:
                                                                e.instructions,
                                                            }),
                                                            e.dependencies &&
                                                                      ...
                                                                      .map(
                                                                        (e) =>
                                                                          ...
                                                                          O.jsxs)(
                                                                            `span`,
                                                                            {
                                                                              className: `text-[8px] font-mono bg-white/5 border border-white/5 text-white/40 px-1 py-0.2 rounded font-semibold`,
                                                                              children:
                                                                                [
                                                                                  `dep: `,
                                                                                  e,
                                  ...
                                  : (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        ...
                                        (0, O.jsx)(`p`, {
                                          className: `text-xs leading-relaxed max-w-[280px]`,
                                          children: `Select an active or past execution run from history (or click trigger) to load the live-updating pipeline visualizer.`,
                                        }),
                                      ],
                                    })
                                : (0, O.jsxs)(`div`, {
                                    ...
                                    children: [
                                      ...
                                      (0, O.jsx)(`p`, {
                                        className: `text-xs leading-relaxed max-w-[280px]`,
                                        children: `Select a workflow definition on the left to inspect its details and view live run graphs.`,
                                      }),
                                    ],
                                  }),
                            }),
                        ...
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsxs)(`div`, {
                              className: `glass-panel rounded-2xl p-5 flex flex-col min-h-[280px]`,
                              children: [
                                (0, O.jsxs)(`div`, {
                                  className: `flex items-center gap-2 border-b border-white/5 pb-3 mb-3`,
                                  children: [
                                ...
                                Kt
                                  ? (() => {
                                      ...
                                      return (0, O.jsxs)(`div`, {
                                        className: `flex-1 flex flex-col gap-4 overflow-y-auto max-h-[400px]`,
                                        children: [
                                          (0, O.jsxs)(`div`, {
                                            children: [
                                              (0, O.jsx)(`span`, {
                                                className: `text-[9px] font-mono bg-white/5 text-teal-300 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider`,
                                                children: Kt.taskTemplateId,
                                              }),
                                              (0, O.jsx)(`h3`, {
                                                className: `text-xs font-bold text-white mt-2 mb-1`,
                                                children: Kt.name,
                                              }),
                                              (0, O.jsxs)(`p`, {
                                                className: `text-[10px] text-white/50 leading-relaxed font-semibold italic`,
                                                children: [
                                                  `"`,
                                                  Kt.instructions,
                                                  `"`,
                                          ...
                                          (0, O.jsxs)(`div`, {
                                            ...
                                            children: [
                                              (0, O.jsx)(`h4`, {
                                                className: `text-[10px] font-bold text-teal-400 uppercase tracking-wider m-0 mb-1.5`,
                                                children: `Execution Link`,
                                              }),
                                              e
                                                ? (0, O.jsxs)(`div`, {
                                                ...
                                                : (0, O.jsx)(`span`, {
                                                    ...
                                                    children: `No run information available.`,
                                                  }),
                                            ],
                                          }),
                                          (0, O.jsxs)(`div`, {
                                            ...
                                            children: [
                                              (0, O.jsx)(`h4`, {
                                                className: `text-[10px] font-bold text-purple-400 uppercase tracking-wider m-0 mb-1.5`,
                                                children: `Variable Context`,
                                              }),
                                              (0, O.jsxs)(`div`, {
                                                className: `space-y-1 text-[8px] font-mono text-purple-300 leading-normal`,
                                                children: [
                                                  (0, O.jsxs)(`div`, {
                                                    children: [
                                                      (0, O.jsx)(`span`, {
                                                      ...
                                                      (0, O.jsx)(`br`, {}),
                                                      (0, O.jsx)(`code`, {
                                                        children: `{{tasks.${Kt.taskTemplateId}.output}}`,
                                                      }),
                                                    ],
                                                  }),
                                                  (0, O.jsxs)(`div`, {
                                                    ...
                                                    children: [
                                                      (0, O.jsx)(`span`, {
                                                        className: `text-white/40`,
                                                        children: `JSON property:`,
                                                      }),
                                                      (0, O.jsx)(`br`, {}),
                                                      (0, O.jsx)(`code`, {
                                                        children: `{{tasks.${Kt.taskTemplateId}.output.propertyName}}`,
                                                      }),
                                                    ],
                                                  }),
                                                ],
                                  ...
                                  : (0, O.jsx)(`div`, {
                                      className: `flex-1 flex items-center justify-center text-xs text-white/30 italic py-8 text-center`,
                                      children: `Click on any task card in the Center Flow to inspect its live status, variables mapping, or trigger low-level drills.`,
                                    }),
                              ],
                            }),
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, O.jsx)(`h2`, {
                                      className: `text-sm font-bold text-white uppercase tracking-wider m-0`,
                                      children: `Live Orchestration Logs`,
                                    }),
                                  ],
                                }),
                                (0, O.jsx)(`div`, {
                                  className: `flex-1 overflow-y-auto space-y-1.5 bg-slate-950/40 p-3 border border-white/5 rounded-xl terminal-font text-[9px] text-teal-300 max-h-[220px]`,
                                  children:
                                    Jt.length === 0
                                      ? (0, O.jsx)(`div`, {
                                          className: `h-full flex items-center justify-center text-white/20 italic`,
                                          children: `Waiting for workflow activity...`,
                                        })
                                      : Jt.map((e, t) =>
                                          (0, O.jsx)(
                                            `div`,
                                            {
                                              className: `leading-normal break-all whitespace-pre-wrap`,
                                              children: e,
                                            },
                                            t,
                                          ),
              ...
              k === `settings` &&
                (0, O.jsxs)(`div`, {
                  ...
                  children: [
                    (0, O.jsx)(`div`, {
                      className: `xl:col-span-5 flex flex-col gap-6 w-full`,
                      children: (0, O.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, O.jsxs)(`form`, {
                            ...
                            children: [
                              (0, O.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, O.jsxs)(`select`, {
                                    value: Je.modelMode,
                                    onChange: (e) =>
                                      Ye({ ...Je, modelMode: e.target.value }),
                                    ...
                                    children: [
                                      (0, O.jsx)(`option`, {
                                        value: `cooperative`,
                                        children: `Cooperative Hybrid (Local + Cloud)`,
                                      }),
                                      (0, O.jsx)(`option`, {
                                        value: `local`,
                                        children: `Local Tactician (Offline First)`,
                                      }),
                                      (0, O.jsx)(`option`, {
                                        value: `cloud`,
                                        children: `Cloud Fallback Only`,
                                      }),
                                    ],
                                  }),
                                  (0, O.jsx)(`span`, {
                                    className: `text-[10px] text-white/40 block leading-normal`,
                                    children: `Hybrid compiles schemas in cloud and executes tool steps locally.`,
                                  }),
                                ],
                              }),
                              (0, O.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, O.jsx)(`h3`, {
                                    className: `text-xs font-bold text-purple-400 uppercase tracking-wider m-0`,
                                    children: `Cloud Strategist`,
                                  }),
                                  (0, O.jsxs)(`div`, {
                                        ...
                                        children: [
                                          ...
                                          (0, O.jsxs)(`select`, {
                                            ...
                                            children: [
                                              (0, O.jsx)(`option`, {
                                                value: `google`,
                                                children: `Google Gemini (Default)`,
                                              }),
                                              (0, O.jsx)(`option`, {
                                                value: `openai`,
                                                children: `OpenAI`,
                              ...
                              (0, O.jsxs)(`div`, {
                                className: `space-y-4 border-t border-white/5 pt-4 transition-opacity duration-300 ${Je.modelMode === `cloud` ? `opacity-40 pointer-events-none` : ``}`,
                                children: [
                                  (0, O.jsx)(`h3`, {
                                    className: `text-xs font-bold text-teal-400 uppercase tracking-wider m-0`,
                                    children: `Local Sidecar (llama-server)`,
                                  }),
                                  Je.modelMode !== `cloud` &&
                                    !Qe.some(
                                      (e) => e.id === et && e.downloaded,
                                    ) &&
                                    et !== `custom` &&
                                    (0, O.jsxs)(`div`, {
                                      className: `p-3.5 rounded-xl border border-amber-500/30 bg-amber-500/10 flex items-start gap-2.5`,
                                      children: [
                                        (0, O.jsx)(Ce, {
                                        ...
                                        (0, O.jsxs)(`div`, {
                                          children: [
                                            (0, O.jsx)(`p`, {
                                              className: `text-xs font-bold text-amber-300 m-0`,
                                              children: `Model download required`,
                                            }),
                                            (0, O.jsxs)(`p`, {
                                              className: `text-[10px] text-amber-200/60 m-0 mt-1 leading-relaxed`,
                                              children: [
                                                `Download a model below to enable `,
                                                Je.modelMode === `cooperative`
                                                  ? `Cooperative`
                                                  : `Local`,
                                                ` mode.`,
                                              ],
                                    ...
                                    children: [
                                      ...
                                      (0, O.jsxs)(`select`, {
                                        ...
                                        onChange: (e) => {
                                          ...
                                          if ((tt(t), t !== `custom`)) {
                                            let e = Qe.find((e) => e.id === t);
                                            e &&
                                              e.downloaded &&
                                              Ye((t) => ({
                                                ...t,
                                                ggufModelPath: e.filename,
                                              }));
                                          }
                                        },
                                        className: `w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-teal-500/50`,
                                        children: [
                                          ...
                                          (0, O.jsx)(`option`, {
                                            value: `custom`,
                                            children: `Custom HuggingFace URL...`,
                                          }),
                                        ],
                                      }),
                                    ],
                                  ...
                                  et === `custom` &&
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, O.jsx)(`label`, {
                                          className: `text-xs font-bold text-white/70`,
                                          children: `Custom HuggingFace GGUF URL`,
                                        }),
                                        (0, O.jsx)(`input`, {
                                          type: `url`,
                                          value: it,
                                  ...
                                  Xe.manifestProgress < 100 &&
                                    Xe.manifestProgress > 0 &&
                                    (0, O.jsxs)(`div`, {
                                      className: `p-4 rounded-xl border border-teal-500/20 bg-teal-500/5 space-y-2`,
                                      children: [
                                        (0, O.jsxs)(`div`, {
                                          className: `flex items-center justify-between text-xs font-bold text-teal-400`,
                                          children: [
                                            (0, O.jsx)(`span`, {
                                    ...
                                    children: [
                                      (0, O.jsx)(`div`, {
                                        ...
                                        children: (0, O.jsxs)(`span`, {
                                          children: [
                                            `Speed Floor (tokens/sec): `,
                                            Je.speedFloor.toFixed(1),
                                          ],
                                        }),
                                      }),
                                      (0, O.jsx)(`input`, {
                                  ...
                                  (0, O.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, O.jsxs)(`div`, {
                                        ...
                                        children: [
                                          (0, O.jsx)(`button`, {
                                            type: `button`,
                                            onClick: $n,
                                            className: `flex-1 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white text-xs font-bold cursor-pointer`,
                                            children: `Start Sidecar`,
                                          }),
                                          (0, O.jsx)(`button`, {
                                            type: `button`,
                                            onClick: er,
                                      ...
                                      (0, O.jsxs)(`button`, {
                                        type: `button`,
                                        onClick: tr,
                                        className: `w-full py-2 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/20 text-rose-300 text-xs font-bold flex items-center justify-center gap-1.5 cursor-pointer`,
                                        children: [
                                          (0, O.jsx)(T, {
                                            className: `w-3.5 h-3.5`,
                                          }),
                                          ` Erase Cache & Wipe Slots`,
                                        ],
                                      }),
                                    ],
                                  }),
                    ...
                    (0, O.jsxs)(`div`, {
                      className: `xl:col-span-7 flex flex-col gap-6 w-full`,
                      children: [
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, O.jsx)(`h2`, {
                                  className: `text-sm font-bold text-white uppercase tracking-wider m-0`,
                                  children: `Add OpenAPI Dynamic Integration`,
                                }),
                              ],
                            }),
                            jt &&
                              (0, O.jsx)(`div`, {
                                className: `p-3.5 rounded-xl border border-rose-500/30 bg-rose-500/10 text-xs text-rose-300 mb-4 leading-normal`,
                                children: jt,
                              }),
                            Nt &&
                              (0, O.jsx)(`div`, {
                                className: `p-3.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 text-xs text-emerald-300 mb-4 leading-normal`,
                                children: Nt,
                              }),
                            (0, O.jsxs)(`form`, {
                              onSubmit: Zn,
                              ...
                              children: [
                                  ...
                                  children: [
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, O.jsx)(`label`, {
                                          className: `text-xs font-bold text-white/70`,
                                          children: `Integration ID (lowercase, alphanumeric)`,
                                        }),
                                        (0, O.jsx)(`input`, {
                                          type: `text`,
                                          value: bt,
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        (0, O.jsxs)(`select`, {
                                          ...
                                          children: [
                                            ...
                                            (0, O.jsx)(`option`, {
                                              value: `apikey`,
                                              children: `Custom Header API Key`,
                                            }),
                                          ],
                                        }),
                                      ],
                                    ...
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, O.jsx)(`label`, {
                                          className: `text-xs font-bold text-white/70`,
                                          children: `Header Key (for API Key only)`,
                                        }),
                                        (0, O.jsx)(`input`, {
                                          type: `text`,
                                          value: Et,
                                          ...
                                          className: `w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-xs text-white placeholder-white/30 focus:outline-none focus:border-teal-500/50 ${wt === `apikey` ? `` : `opacity-45 pointer-events-none`}`,
                                        }),
                                      ],
                                    }),
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        ...
                                        (0, O.jsx)(`input`, {
                                          ...
                                          className: `w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-xs text-white placeholder-white/30 focus:outline-none focus:border-teal-500/50 ${wt === `none` ? `opacity-45 pointer-events-none` : ``}`,
                                        }),
                                      ],
                                    }),
                                  ],
                                ...
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsx)(`label`, {
                                      className: `text-xs font-bold text-white/70`,
                                      children: `OpenAPI Spec (JSON Format)`,
                                    }),
                                    (0, O.jsx)(`textarea`, {
                                      value: kt,
                                      onChange: (e) => At(e.target.value),
                        ...
                        (0, O.jsxs)(`div`, {
                          className: `glass-panel rounded-2xl p-6 flex flex-col min-h-[220px]`,
                          children: [
                            (0, O.jsxs)(`div`, {
                              className: `flex items-center gap-2 border-b border-white/5 pb-3 mb-4`,
                              children: [
                            ...
                            (0, O.jsx)(`div`, {
                              ...
                              children:
                                vt.length === 0
                                  ? (0, O.jsx)(`div`, {
                                      className: `h-full flex items-center justify-center text-xs text-white/30 italic py-8 text-center`,
                                      children: `No custom OpenAPI specifications registered. Add one using the form above.`,
                                    })
                                  : vt.map((e) =>
                                      (0, O.jsxs)(
                                        `div`,
                                        {
                                          className: `p-4 rounded-xl border border-white/5 bg-white/2 hover:border-white/10 flex items-start justify-between gap-4 transition-all`,
                                          children: [
                                            (0, O.jsxs)(`div`, {
                                              className: `flex-1`,
                                              children: [
                                                (0, O.jsxs)(`div`, {
                                                  ...
                                                  children: [
                                                    (0, O.jsx)(`span`, {
                                                      className: `text-[10px] font-bold font-mono px-2 py-0.5 rounded bg-purple-500/15 border border-purple-500/20 text-purple-300`,
                                                      children: e.id,
                                                    }),
                                                    (0, O.jsx)(`span`, {
                                                      className: `font-bold text-xs text-white`,
                                                ...
                                                (0, O.jsxs)(`div`, {
                                                  className: `flex items-center gap-3 text-[10px] text-white/40 mt-1.5`,
                                                  children: [
                                                    (0, O.jsxs)(`span`, {
                                                      children: [
                                                        `Auth Type: `,
                                                        (0, O.jsx)(`span`, {
                                                          className: `font-bold capitalize text-white/60`,
                                                          children: e.authType,
                                                        }),
                                                      ],
                                                    }),
          ...
          ` `,
          (0, O.jsx)(`div`, {
            className: `flex flex-col gap-6 w-full lg:h-full lg:min-h-0 ${o ? `lg:col-span-12` : `lg:col-span-4`}`,
            children: (0, O.jsxs)(`div`, {
              className: `glass-panel rounded-2xl p-5 flex flex-col h-full min-h-0`,
              children: [
                (0, O.jsxs)(`div`, {
                  className: `flex items-center justify-between border-b border-white/5 pb-3 mb-3`,
                  children: [
                    (0, O.jsxs)(`div`, {
                      className: `flex items-center gap-2`,
                      children: [
                        (0, O.jsx)(xe, { className: `w-5 h-5 text-teal-400` }),
                        (0, O.jsx)(`h2`, {
                          className: `text-base font-bold text-white leading-none`,
                    ...
                    (0, O.jsx)(`button`, {
                      ...
                      title: o ? `Exit Fullscreen` : `Fullscreen Chat`,
                      children: o
                        ? (0, O.jsx)(he, { className: `w-4 h-4` })
                        : (0, O.jsx)(me, { className: `w-4 h-4` }),
                    }),
                  ],
                }),
                (0, O.jsx)(`p`, {
                  className: `text-xs text-white/50 leading-relaxed mb-3`,
                  children: `Submit Natural Language instructions to route workflows, run jobs, or trigger scheduled agent heartbeats.`,
                }),
                (0, O.jsxs)(`div`, {
                  className: `flex-1 overflow-y-auto space-y-3.5 pr-2 mb-4`,
                  children: [
                    c.map((e, t) =>
                      e.type === `promotion`
                        ? (0, O.jsxs)(
                            `div`,
                            {
                              className: `glass-panel border-amber-500/30 bg-gradient-to-r from-amber-500/10 to-rose-500/10 rounded-xl p-4 my-2 border shadow-lg shadow-amber-950/10 animate-fade-in flex items-start gap-3`,
                              children: [
                                (0, O.jsx)(`div`, {
                                  className: `p-2 rounded-lg bg-amber-500/20 text-amber-400 shrink-0`,
                                  children: (0, O.jsx)(ye, {
                                ...
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsx)(`h4`, {
                                      className: `font-bold text-xs text-amber-300 flex items-center gap-1.5 uppercase tracking-wider m-0`,
                                      children: `System Promotion Notice`,
                                    }),
                                    (0, O.jsx)(`p`, {
                                      className: `text-xs text-white/95 mt-1 leading-relaxed m-0 font-medium`,
                                      children: e.text,
                                    }),
                                  ],
                                }),
                        ...
                        : e.type === `audit`
                          ? (0, O.jsxs)(
                              `div`,
                              {
                                className: `glass-panel border-emerald-500/20 bg-emerald-500/5 rounded-xl p-3.5 my-2 border shadow-lg shadow-emerald-950/10 animate-fade-in flex items-start gap-3`,
                                children: [
                                  (0, O.jsx)(`div`, {
                                    className: `p-2 rounded-lg bg-emerald-500/20 text-emerald-400 shrink-0`,
                                    children: (0, O.jsx)(se, {
                                      className: `w-4 h-4`,
                                    }),
                                  }),
                                  (0, O.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, O.jsx)(`h4`, {
                                        className: `font-bold text-xs text-emerald-400 flex items-center gap-1.5 uppercase tracking-wider m-0`,
                                        children: `Observer Verification Audit`,
                                      }),
                                      (0, O.jsx)(`p`, {
                                        className: `text-xs text-white/95 mt-1 leading-relaxed m-0 font-medium`,
                                        children: e.text,
                          ...
                          : (0, O.jsxs)(
                              `div`,
                              {
                                className: `flex flex-col text-xs rounded-xl p-3 border ${e.type === `user` ? `bg-purple-950/20 border-purple-500/20 self-end max-w-[85%]` : e.type === `agent` ? `bg-teal-950/15 border-teal-500/15 max-w-[90%]` : `bg-white/3 border-white/5 text-white/80`}`,
                                children: [
                                  (0, O.jsxs)(`div`, {
                                    className: `flex items-center justify-between gap-2 mb-1 opacity-60 font-medium`,
                                    children: [
                                      (0, O.jsxs)(`span`, {
                                        className: `text-[10px] text-teal-300 font-bold`,
                                        children: [`[`, e.sender, `]`],
                                      }),
                                      (0, O.jsx)(`span`, { children: e.time }),
                                    ],
                                  }),
                                  (0, O.jsxs)(`p`, {
                                    className: `text-white/90 break-words leading-relaxed m-0 flex items-center gap-1.5`,
                                    children: [
                                      e.text,
                                      e.isStreaming &&
                                        (0, O.jsxs)(`span`, {
                ...
                (0, O.jsxs)(`form`, {
                  ...
                  children: [
                    ...
                    (0, O.jsx)(`button`, {
                      ...
                      children: (0, O.jsx)(_e, { className: `w-3.5 h-3.5` }),
                    }),
                  ],
                }),
              ],
      ...
      (0, O.jsxs)(`div`, {
        className: `fixed inset-y-0 right-0 z-50 w-full max-w-xl drawer-panel border-l border-white/10 shadow-2xl transition-transform duration-500 ease-in-out transform flex flex-col ${Xt ? `translate-x-0` : `translate-x-full`}`,
        children: [
          (0, O.jsxs)(`div`, {
            ...
            children: [
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsx)(we, { className: `w-5 h-5 text-teal-400` }),
                  (0, O.jsx)(`h3`, {
                    className: `text-base font-bold`,
                    children: Qt ? `Edit Workflow` : `Create New Workflow`,
                  }),
                ],
              }),
              (0, O.jsx)(`button`, {
                ...
                children: (0, O.jsx)(Te, { className: `w-4 h-4` }),
              }),
            ],
          }),
          (0, O.jsxs)(`form`, {
            ...
            children: [
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsx)(`h4`, {
                    className: `text-xs font-bold text-teal-400 uppercase tracking-wider border-b border-white/5 pb-1 m-0`,
                        ...
                        children: [
                          ...
                          (0, O.jsxs)(`select`, {
                            ...
                            children: [
                              (0, O.jsx)(`option`, {
                                value: `manual`,
                                children: `Manual Trigger Only`,
                              }),
                              (0, O.jsx)(`option`, {
                                value: `cron`,
                                children: `Scheduled Cron Loop`,
                              }),
                            ],
                          }),
                        ],
                      ...
                      an === `cron` &&
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, O.jsx)(`span`, {
                              className: `text-[9px] text-white/40 block leading-tight`,
                              children: `Standard 5-field cron (Min Hour Day Month DOW).`,
                            }),
                          ],
                        }),
                    ],
              ...
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsxs)(`h4`, {
                    className: `text-xs font-bold text-teal-400 uppercase tracking-wider border-b border-white/5 pb-1 m-0`,
                    children: [`Pipeline Nodes (`, ln.length, `)`],
                  }),
                  (0, O.jsx)(`div`, {
                    ...
                    children:
                      ln.length === 0
                        ? (0, O.jsx)(`div`, {
                            className: `p-4 rounded-xl border border-dashed border-white/10 text-center text-xs text-white/30 italic`,
                            children: `No tasks added to this workflow yet. Define your first task node below.`,
                          })
                        : ln.map((e) =>
                            (0, O.jsxs)(
                              `div`,
                              {
                                className: `p-3 rounded-xl border border-white/5 bg-white/2 flex items-start justify-between gap-3`,
                                children: [
                                  (0, O.jsxs)(`div`, {
                                    className: `flex-1`,
                                    children: [
                                      (0, O.jsxs)(`div`, {
                                        ...
                                        children: [
                                          (0, O.jsx)(`span`, {
                                            className: `text-[8px] font-mono bg-white/5 text-purple-300 px-1 py-0.2 rounded font-bold`,
                                            children: e.taskTemplateId,
                                          }),
                                          (0, O.jsx)(`span`, {
                                            className: `font-bold text-xs text-white`,
                                            children: e.name,
                                      ...
                                      (0, O.jsx)(`p`, {
                                        className: `text-[10px] text-white/60 mt-1 leading-normal m-0 line-clamp-2`,
                                        children: e.instructions,
                                      }),
                                      e.dependencies &&
                                        (0, O.jsxs)(`div`, {
                                          className: `text-[8px] text-teal-400 font-mono mt-1`,
                                          children: [
                                            `depends on: `,
                                            e.dependencies,
                                          ],
                  ...
                  (0, O.jsxs)(`div`, {
                    className: `p-4 rounded-xl border border-white/5 bg-slate-950/20 space-y-3`,
                    children: [
                      (0, O.jsx)(`h5`, {
                        className: `text-[10px] font-bold text-white uppercase tracking-wider m-0`,
                        children: `Add Pipeline Task Node`,
                      }),
                      (0, O.jsxs)(`div`, {
                          ...
                          (0, O.jsxs)(`div`, {
                            ...
                            children: [
                              (0, O.jsx)(`label`, {
                                ...
                                children: `Task Template ID (unique)`,
                              }),
                              (0, O.jsx)(`input`, {
                                type: `text`,
                                value: dn,
                      ...
                      (0, O.jsxs)(`div`, {
                        ...
                        children: [
                          (0, O.jsx)(`label`, {
                            className: `text-[9px] font-bold text-white/50`,
                            children: `Natural Language Instructions`,
                          }),
                          (0, O.jsx)(`textarea`, {
                            value: hn,
                      ...
                      ln.length > 0 &&
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsx)(`label`, {
                              className: `text-[9px] font-bold text-white/50 block`,
                              children: `Dependencies (Prerequisites)`,
                            }),
                            (0, O.jsx)(`div`, {
                              className: `flex flex-wrap gap-2 max-h-[80px] overflow-y-auto pr-1`,
                              children: ln.map((e) => {
                                let t = _n.includes(e.taskTemplateId);
                                return (0, O.jsxs)(
                                  `label`,
                                  {
                                    className: `flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-[9px] font-mono cursor-pointer transition-all ${t ? `bg-teal-500/10 border-teal-500/30 text-teal-400 font-bold` : `bg-white/2 border-white/5 text-white/60 hover:bg-white/5`}`,
                                    children: [
                                      (0, O.jsx)(`input`, {
                                        type: `checkbox`,
                                        checked: t,
                      ...
                      (0, O.jsxs)(`button`, {
                        ...
                        children: [
                          (0, O.jsx)(D, { className: `w-3.5 h-3.5` }),
              ...
              (0, O.jsx)(`button`, {
                ...
                children: Qt ? `Save Changes` : `Create Workflow Pipeline`,
              }),
            ],
          }),
        ],
      ...
      i &&
        (0, O.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, O.jsxs)(`div`, {
              className: `relative w-full max-w-md h-full bg-slate-900/90 border-l border-white/10 backdrop-blur-xl shadow-2xl flex flex-col z-10 transition-all duration-300 animate-slide-in text-white`,
              children: [
                (0, O.jsxs)(`div`, {
                  className: `p-4 border-b border-white/10 flex items-center justify-between bg-slate-950/40`,
                  children: [
                    (0, O.jsxs)(`div`, {
                      className: `flex items-center gap-2`,
                      children: [
                        (0, O.jsx)(ie, { className: `w-5 h-5 text-teal-400` }),
                        (0, O.jsx)(`h2`, {
                          className: `text-base font-black tracking-tight`,
                          children: `Notification Center`,
                        }),
                        n.filter((e) => e.status === `unread`).length > 0 &&
                          (0, O.jsxs)(`span`, {
                            className: `px-2 py-0.5 rounded-full bg-rose-500/20 border border-rose-500/30 text-rose-400 text-[10px] font-black`,
                            children: [
                              n.filter((e) => e.status === `unread`).length,
                              ` new`,
                            ],
                    ...
                    (0, O.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, O.jsx)(`button`, {
                          ...
                          children: (0, O.jsx)(Te, { className: `w-5 h-5` }),
                        }),
                      ],
                    }),
                  ],
                ...
                (0, O.jsx)(`div`, {
                  ...
                  children:
                    n.length === 0
                      ? (0, O.jsxs)(`div`, {
                          className: `h-full flex flex-col items-center justify-center text-center text-white/30 space-y-2`,
                          children: [
                            (0, O.jsx)(ie, { className: `w-10 h-10 stroke-1` }),
                            (0, O.jsx)(`p`, {
                            ...
                            (0, O.jsx)(`span`, {
                              className: `text-[10px]`,
                              children: `As background tasks and events trigger, alerts will appear durably here.`,
                            }),
                          ],
                        })
                      : n.map((e) => {
                          let t = e.status === `unread`,
                            n,
                            r;
                          e.type === `warning`
                            ? ((n = t
                                ? `border-amber-500 border-l-4 bg-amber-500/5 hover:bg-amber-500/10`
                                : `border-white/5 bg-white/3 hover:bg-white/5 text-amber-400`),
                              (r = `bg-amber-500/10 text-amber-400`))
                            : e.type === `error`
                              ? ((n = t
                                  ? `border-rose-500 border-l-4 bg-rose-500/5 hover:bg-rose-500/10`
                                  : `border-white/5 bg-white/3 hover:bg-white/5 text-rose-400`),
                                (r = `bg-rose-500/10 text-rose-400`))
                              : e.type === `action_required`
                                ? ((n = t
                                    ? `border-purple-500 border-l-4 bg-purple-500/5 hover:bg-purple-500/10`
                                    : `border-white/5 bg-white/3 hover:bg-white/5 text-purple-400`),
                                  (r = `bg-purple-500/10 text-purple-400`))
                                : ((n = t
                                    ? `border-teal-500 border-l-4 bg-teal-500/5 hover:bg-teal-500/10`
                                    : `border-white/5 bg-white/3 hover:bg-white/5 text-teal-400`),
                                  (r = `bg-teal-500/10 text-teal-400`));
                          let i = e.source.toUpperCase();
                          return (
                            e.source === `executor` && (i = `Task Tactician`),
                            e.source === `observer` && (i = `Observer Agent`),
                            e.source === `workflow_orchestrator` &&
                              (i = `Workflows`),
                            e.source === `sidecar` && (i = `Llama-Server`),
                            (0, O.jsxs)(
                              `div`,
                              {
                                onClick: () => Nn(e),
                                className: `group p-3.5 rounded-xl border transition-all duration-200 cursor-pointer relative hover:scale-[1.02] hover:shadow-lg ${n}`,
                                children: [
                                  (0, O.jsxs)(`div`, {
                                    className: `flex items-start gap-3`,
                                    children: [
                                      (0, O.jsxs)(`div`, {
                                        className: `p-2 rounded-lg ${r} transition-all`,
                                        children: [
                                          e.source === `executor` &&
                                            (0, O.jsx)(xe, {
                                              className: `w-4 h-4`,
                                      ...
                                      (0, O.jsxs)(`div`, {
                                        ...
                                        children: [
                                          ...
                                          (0, O.jsx)(`h4`, {
                                            className: `font-bold text-xs text-white mt-1 group-hover:text-teal-300 transition-all`,
                                            children: e.title,
                                          }),
                                          (0, O.jsx)(`p`, {
                                            className: `text-[10px] text-white/60 mt-1 leading-relaxed whitespace-pre-wrap`,
                                            children: e.message,
                                          }),
                                          (e.taskId ||
                                            e.workflowId ||
                                            ...
                                            (0, O.jsxs)(`div`, {
                                              ...
                                              children: [
                                                e.taskId &&
                                                  (0, O.jsxs)(`span`, {
                                                    className: `px-2 py-0.5 rounded bg-white/5 border border-white/10 text-[8px] font-mono text-white/50`,
                                                    children: [
                                                      `Task: `,
                                                      e.taskId.slice(-8),
                                                    ],
                                                ...
                                                e.workflowId &&
                                                  (0, O.jsxs)(`span`, {
                                                    ...
                                                    children: [
                                                      `Workflow: `,
                                                      e.workflowId.slice(-8),
                                                    ],
                                                  }),
                                                e.targetId &&
                                                  (0, O.jsxs)(`span`, {
                                                    className: `px-2 py-0.5 rounded bg-teal-500/10 border border-teal-500/20 text-[8px] font-mono text-teal-300`,
                                                    children: [
                                                      `Target: `,
                                                      e.targetId,
                                                    ],
                                  ...
                                  t &&
                                    (0, O.jsx)(`button`, {
                                      onClick: (t) => {
                                        (t.stopPropagation(), jn(e.id, `read`));
                                      },
...
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, O.jsx)(_.StrictMode, { children: (0, O.jsx)(De, {}) }),
);
