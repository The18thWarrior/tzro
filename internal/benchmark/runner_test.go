...
func TestParameterMatching(t *testing.T) {
	...
	if !matchParameters("test_schema_tool", "user message", expectedArgs, actualArgs) {
	...
	if matchParameters("test_schema_tool", "user message", expectedArgs, actualArgsMissingRequired) {
	...
	if !matchParameters("test_schema_tool", "user message", expectedArgs, actualArgsUnexpectedDefault) {
	...
	if matchParameters("test_schema_tool", "user message", expectedArgs, actualArgsUnexpectedHallucinated) {
	...
	if !matchParameters("test_schema_tool", "user message", expectedNestedArgs, actualNestedArgs) {
	...
	if !matchParameters("test_schema_tool", "user message", expectedNumericArgs, actualNumericArgs) {
	...
	if !matchParameters("test_schema_tool", "user message", expectedSliceScalarArgs, actualScalarArgs) {
	...
	if !matchParameters("test_schema_tool", "user message", expectedScalarArgs, actualSliceArgs) {
