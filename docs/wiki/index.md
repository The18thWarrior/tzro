...
- [ADR-0081: Neural Embedding Policy and Heuristic Deprecation](../adr/0081-neural-embedding-policy-and-heuristic-deprecation.md) - Prohibits brittle regex/string slicing for semantic routing and mandates the Neural Embedding Sidecar (All-MiniLM-L6-v2) for evidence extraction, query decomposition, and schema resolution.
